...
public class CanPackageFactory : ICanPackageFactory
{
    ...
    {
        Register(0x401, "Состояние источника питания", (p, n) => new IdStatusPwr(p, n));
        Register(0x4C3, "Состояние ПП", (p, n) => new IdStatusCapno2(p, n));
        Register(0x442, "Состояние платы смесителя газов", (p, n) => new IdStatusMix(p, n));
        ...
        Register(0x5A9, "Состояние контроллера мотора", (p, n) => new IdStatusMotor(p, n));
