...
public class IdStatusSpo_v2_1 : BasePackageParsed
{
    ...
    private static readonly Dictionary<ulong, MessageDefinition> SensorTypeDefinitions = new()
    {
        ...
        [2] = new("Тип датчика: резерв"),
        [3] = new("Тип датчика: резерв"),
        ...
        [6] = new("Тип датчика: резерв"),
        [7] = new("Тип датчика: резерв"),
        [8] = new("Тип датчика: резерв"),
        [9] = new("Тип датчика: резерв"),
        [10] = new("Тип датчика: резерв"),
        [11] = new("Тип датчика: резерв"),
        [12] = new("Тип датчика: резерв"),
        [13] = new("Тип датчика: резерв"),
        [14] = new("Тип датчика: резерв"),
        [15] = new("Тип датчика: резерв"),
    };
